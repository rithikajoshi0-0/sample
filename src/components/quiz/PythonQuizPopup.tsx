    ...
    return (
      ...
      >
        <div className="bg-[#1a1a2e] rounded-2xl p-6 max-w-md w-full m-4 text-center">
          <p className="text-xl text-white mb-4">No questions available for this module yet.</p>
          <button onClick={onClose} className="px-4 py-2 bg-blue-500 hover:bg-blue-600 rounded-lg transition-colors">
            Close
          </button>
        </div>
      </motion.div>
